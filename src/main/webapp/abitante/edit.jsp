...
<body>
	...
	<div class="container">
		...
		<form class="form-horizontal"
			action="${pageContext.request.contextPath }/ExecuteModificaAbitanteServlet?idAbitante=${abitanteAttribute.id}"
			method="post">
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<input class="form-control" type="text" id="municipioInputId"
						name="municipioInput"> <input type="hidden"
						name="municipioId" id="municipioId"
